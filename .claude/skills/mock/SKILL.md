...
| Loader do tema, estrutura e template do mock, estados a mostrar, comentários no arquivo, recorte de partials, porte das peças | **esta skill** |
...
- [ ] Renderizado sobre a condição real de uso, não sobre fundo chapado.
