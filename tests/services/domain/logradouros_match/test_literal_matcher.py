...
def _catalog_padrao() -> FakeCatalog:
    rows = [
        ...
        LogradouroRow(codlog="000006", dv="0", tipo_logradouro="AV", nm_logradouro="PAULINO GUEDES"),
        LogradouroRow(codlog="000008", dv="0", tipo_logradouro="R", nm_logradouro="PAULO AFONSO"),
        # "BRASIL" aparece no meio (não é prefixo) — para testes do fallback substring
        LogradouroRow(codlog="000009", dv="0", tipo_logradouro="R", nm_logradouro="JARDIM BRASIL"),
    ]
    variacoes = {
        "AVENIDA": "AV",
        "AV": "AV",
