...
from services.scripts.augment_tipos_logradouro import AugmentConfig, gerar_variacoes_nome, run
...
@pytest.fixture
def insumos_sinteticos() -> AugmentConfig:
...
def test_run_normaliza_chaves(insumos_sinteticos: AugmentConfig) -> None:
...
def test_run_idempotente(insumos_sinteticos: AugmentConfig) -> None:
...
def test_augment_verbose_apura_variacoes_por_tipo(insumos_sinteticos: AugmentConfig) -> None:
