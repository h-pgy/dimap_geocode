"""Testes de apps/competencias/views.py (SPEC autorizacao/007): a tela de atribuições da unidade —
quem a abre, que organograma ela oferece como alvo, e os dois atos que ela pratica.
...
que estes testes fixam é que a rota cumpre as duas sem a view conferir nada.
